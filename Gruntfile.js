module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-lambda-delete'
                        // standalone: 'mitchallen.-marchio-lambda-delete'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-lambda-delete.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-lambda-delete.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-lambda-delete.min.js': ['./dist/marchio-lambda-delete.js']
                }
            }
        },
